	...
	<div class="container">
		...
		<div class="advant__column d-flex">
			...
			<div class="advant__item d-flex">
				...
				<div class="advant__item-right">
					<p>
						Конфиденциальность клиентской <br>
						информации.
					</p>
				</div>
			</div>
		...
		<div class="info__column d-flex">
			...
			<div class="info__item">
				...
				<p>
					...
					для вашего бизнеса по телефону <br/><strong>бесплатно</strong>
				</p>
			</div>
			...
			<div class="info__item">
				...
				<p>
					Стоимость консультации по электронной почте определяется по договоренности сторон.
				</p>
			</div>
